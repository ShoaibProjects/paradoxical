...
function Header() {
    return (
        <>
            <header className="fixed w-full bg-opacity-30 backdrop-blur-md bg-slate-700 shadow-md py-4 md:py-3 px-5 flex justify-between md:justify-start items-center z-50">
                <Link to="/">
